  ...
  return (
    <Background backgroundImage={IMAGE_URLS.market.npc_shop_bg}>
      ...
      <div className="absolute bottom-24 left-1/2 -translate-x-1/2 w-75 flex items-center gap-x-14">
        {PRODUCT_LIST.slice(productIndex * 3, (productIndex + 1) * 3).map(
          (product) => (
            <div
        ...
        {PRODUCT_LIST.slice(productIndex * 3, (productIndex + 1) * 3).map(
          (product) => (
            <div
              ...
              onClick={() => handleProductClick(product)}
            >
              <div className="text-[#6E532C] text-[0.65rem] font-bold">
                {product.name}
              </div>
              <div className="flex items-center gap-1">
                ...
                />
                <div className="text-[0.6rem] text-[#6E532C] font-bold">
                  {product.price}냥
                </div>
              </div>
            </div>
