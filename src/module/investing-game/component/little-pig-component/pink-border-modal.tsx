...
export const PinkBorderModal = ({ children, className = "" }: PinkBorderModalProps) => {
  return (
    <div className="relative flex items-center justify-center w-[33.5rem] h-[21.5rem] bg-main-pink-500 border-2 sm:border-5 border-main-brown-550 rounded-4xl">
      <div
        className={`relative px-10 w-[32rem] h-[20rem] bg-white border-2 sm:border-5 border-main-brown-550 rounded-3xl ${className}`}
      >
        {children}
