...
export const QuestTemplate = ({ onClickQuest }: QuestTemplateProps) => {
  return (
    // 배경 이미지
    <Background
    ...
    >
      ...
      />
      <div className="absolute xl:left-[33.5rem] top-[9.6rem] md:left-[33.2rem]">
        <TextWithStroke
          text="일일"
          textClassName="text-main-yellow-300 text-[0.9rem] "
          strokeClassName="text-main-brown-600 text-[0.9rem] text-stroke-width-[0.3rem] text-stroke-color-main-brown-800"
      ...
      <TextWithStroke
        ...
        textClassName="text-main-yellow-800 text-[2.5rem] "
      ...
      <img
        ...
        alt="고민하는 포니"
        className="absolute h-40 left-[14.5rem] xl:top-[16.97rem] md:top-[16.8rem]"
      />
      ...
      <TextWithStroke
        text="일일"
        className="absolute left-[8rem] top-[12.8rem] md:left-[7.8rem] "
        textClassName="text-main-yellow-300 text-[1.5rem] "
        strokeClassName="text-main-brown-600 text-[1.5rem] text-stroke-width-[0.3rem] text-stroke-color-main-brown-800"
      />
      <TextWithStroke
        text="퀘스트"
        className="absolute left-[4.5rem] top-[14.35rem] md:left-[4.3rem]"
        textClassName="text-main-yellow-300 text-[1.5rem] "
        strokeClassName="text-main-brown-600 text-[1.5rem] text-stroke-width-[0.3rem] text-stroke-color-main-brown-800"
      />
